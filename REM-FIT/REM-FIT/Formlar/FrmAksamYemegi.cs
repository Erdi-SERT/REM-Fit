...
{
    public partial class FrmAksamYemegi : Form
    {
        public FrmAksamYemegi()
        {
            InitializeComponent();
        }              
        ...
        private void btnEkle_Click(object sender, EventArgs e)
        {
            ...
            foreach (var item in db.Kullanıcılar)
            {
                ...
                {
                    dgvGunlukListe.DataSource = db.TüketildiğiÖğün.Where(x => x.TükedildiğiTarih.Day == DateTime.Now.Day && x.TükedildiğiTarih.Year == DateTime.Now.Year && x.TüketildiğiÖğün1 == 2).Select(x => new
                    {
        ...
        private void FrmAksamYemegi_Load(object sender, EventArgs e)
        {
