...
{
    public partial class FrmAraOgun : Form
    {
        public FrmAraOgun()
        {
            InitializeComponent();
        ...
        private void btnEkle_Click(object sender, EventArgs e)
        {
            ...
            foreach (var item in db.Kullanıcılar)
            {
                ...
                {
                    dgvGunlukListe.DataSource = db.TüketildiğiÖğün.Where(x => x.TükedildiğiTarih.Day == DateTime.Now.Day && x.TükedildiğiTarih.Year == DateTime.Now.Year && x.TüketildiğiÖğün1 == 3).Select(x => new
                    {
        ...
        private void FrmAraOgun_Load(object sender, EventArgs e)
        {
