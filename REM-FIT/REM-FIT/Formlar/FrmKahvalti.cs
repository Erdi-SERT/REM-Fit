...
{
    public partial class FrmKahvalti : Form
    {
        public FrmKahvalti()
        {
            InitializeComponent();
        ...
        private void FrmKahvalti_Load(object sender, EventArgs e)
        {
            db = new RemFitKaloriEntitiesSon();
            VerileriDoldur(db.Besinlers.ToList(), cmbKahvaltiMenu);
        }
        ...
        private void btnEkle_Click(object sender, EventArgs e)
        {
            ...
            if (numericUpDown1.Value > 0 && cmbKahvaltiMenu.SelectedIndex > 0)
            {

                foreach (var item in db.Besinlers)
                {
                    if (cmbKahvaltiMenu.SelectedIndex == item.BesinID)
                    {
                        ...
                        db.TüketildiğiÖğün.Add(new TüketildiğiÖğün()
                        {
                            ...
                            UserID_UserID = userID,
                            Kalori = tüketilenkalori
                        });
                        //Controls_Tooltip("", "Besin Eklendi", btnEkle_Click);
            ...
            foreach (var item in db.Kullanıcılar)
            {
                ...
                {
                    dgvGunlukListe.DataSource = db.TüketildiğiÖğün.Where(x => x.TükedildiğiTarih.Day == DateTime.Now.Day && x.TükedildiğiTarih.Year == DateTime.Now.Year && x.TüketildiğiÖğün1 == 0).Select(x => new
                    {
        ...
        private void btnKahvaltiEkle_Click_1(object sender, EventArgs e)
        {
            Temizle(grpKahvalti);
        }
        ...
        private void btnUzmanaSor_Click_1(object sender, EventArgs e)
        {
        ...
        private void btnKahvalti_Click_1(object sender, EventArgs e)
        {
        ...
        private void btnOgle_Click_1(object sender, EventArgs e)
        {
        ...
        private void btnAksam_Click_1(object sender, EventArgs e)
        {
        ...
        private void btnAraOgun_Click_1(object sender, EventArgs e)
        {
        ...
        private void dgvGunlukListe_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
